    ...
    <section className="bg-gray-50 py-12 md:py-20 text-center px-4">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-4">
          <Link
            className=" border border-[#004DFB] text-[#004DFB] px-6 py-3 md:py-4 rounded-full transition w-full md:w-auto"
            href="/auth/signup"
          >
            Explore open opportunities
          </Link>
          <button className="text-white px-6 py-3 md:py-4 rounded-full bg-[#004DFB] transition w-full md:w-auto">
