  ...
  return (
    <section className="bg-white py-12 md:py-20 px-4">
      ...
      <div className="text-center mb-12">
        <h3 className="text-[#004DFB] text-sm md:text-lg font-semibold mb-2 flex items-center justify-center">
          Employee Success Story
        </h3>

        <h2 className="text-2xl md:text-4xl text-[#004DFB] font-bold mb-4">
      ...
      <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center gap-6 md:gap-10">
        ...
        <div className="flex-1 w-full order-last md:order-first">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 md:w-16 h-14 md:h-16 bg-gray-100 rounded-full flex items-center justify-center font-bold text-[#004DFB] bg-gradient-to-br from-[#4C63A2] to-[#1C253C] flex-shrink-0">
              <Image
            ...
            <div>
              <p className="font-bold text-lg md:text-2xl text-[#004DFB]">
                Robert Stewart
              </p>
